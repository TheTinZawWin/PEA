...
gj.widget = function () {
    ...
    }, gj[b].config.base), d = a.hasOwnProperty("uiLibrary") ? a.uiLibrary : c.uiLibrary, gj[b].config[d] && $.extend(!0, c, gj[b].config[d]), e = a.hasOwnProperty("iconsLibrary") ? a.iconsLibrary : c.iconsLibrary, gj[b].config[e] && $.extend(!0, c, gj[b].config[e]);
    ...
    }), $.extend(d.dataSource.data, d.params), b = $.extend(!0, {
    ...
    function (a) {
        ...
        useHtmlDataSource: function (a, b) {
            ...
            }, d[b.valueField] = f[c].value, d[b.textField] = f[c].innerHTML, d[b.selectedField] = a[0].value === f[c].value, e.push(d);
            b.dataSource = e
        },
        filter: function (a) {
            var b, c, d = a.data();
            if (d.dataSource) {
                if ("string" == typeof d.dataSource[0])
                    for (b = 0; b < d.dataSource.length; b++) c = {
    ...
    function (a) {
        ...
        base: {
            ...
            locale: "en-us",
            icons: {
                //Modified by Joshua 20180726
                //rightIcon: '<i class="gj-icon">event</i>',
                rightIcon: '<i class="fa fa-table"></i>',
